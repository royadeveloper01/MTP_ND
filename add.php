    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        if ($name === '' || $price <= 0 || !in_array($category, $allowedCategories, true)) {
            ...
            try {
                ...
                error_log("Product Add Database Error: " . $e->getMessage());
...
<div class="container my-5">
    <div class="card p-4 mx-auto form-max-width">
        <h1 class="card-title text-center mb-4">Add New Product</h1>
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="category" value="male" 
                           id="categoryMale" <?= (($_POST['category'] ?? '') === 'male') ? 'checked' : '' ?>>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="category" value="female" 
                           id="categoryFemale" <?= (($_POST['category'] ?? '') === 'female') ? 'checked' : '' ?>>
