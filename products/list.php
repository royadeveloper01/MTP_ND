...
// Fetch products
// NOTE: Query is safe as it contains no user input.
                    ...
                    <div class="card h-100 shadow-sm">
                        <div class="image-thumb">
                            <?php if (!empty($p['image'])): 
                                ...
                                $isUrl = preg_match('/^https?:\/\//i', $p['image']);
                                
                                if ($isUrl) {
                                    $image_src = $p['image']; 
                                } else {
                                    // SECURITY FIX (Path Traversal Prevention): Use basename() to strip any directory components
                                    $cleanFilename = basename($p['image']);
                                    // Construct the path
                                    $image_src = '../uploads/' . $cleanFilename;
                                }
                            ?>
