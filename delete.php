...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    // SECURITY/UX: Use relative URL 'list.php' if BASE_URL is not defined or reliable
...
try {
    ...
    // Assuming cascade delete is NOT set up, explicit deletion is safer.
    // We can rely on the original script's behavior if the DB handles it,
    // but explicit deletion of related tables is best practice for data integrity.
